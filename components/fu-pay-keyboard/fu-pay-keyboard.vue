<template>
	<view v-if="show">
		...
		<view :class="['content', show ? '' : 'contenthide']">
          ...
          <image src="/static/shop/close.png" />
        </view>
			...
			<view class="pay-money">
				<view>金额</view>
				<view class="money text-osd">￥ <text>{{money}}</text></view>
			</view>
			<view class="pay-way">
				<view>支付方式</view>
		...
		<view :class="['keyboard', show ? '' : 'active', isIphoneX ? 'isIphone' : '']">
			...
			<view class="keyboard-item delte" @tap="del()"><image class="img" src="/static/shop/del.png" mode="aspectFill" :lazy-load="true"></image></view>
		</view>
	</view>
</template>
